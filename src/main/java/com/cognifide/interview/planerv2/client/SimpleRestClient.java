...
public class SimpleRestClient {
	...
	public static void removeBuilding(HttpClient httpClient) {
		try {
			...
			String results = httpClient
					.sendRequestAndWait(httpRequest, HttpClient.HTTP_CLIENT_DEFAULT_TIMEOUT, TimeUnit.SECONDS).body();
	...
	public static void getBuilding(HttpClient httpClient) {
		try {
	...
	public static void getRoom(HttpClient httpClient) {
		try {
			String results = httpClient.get("http://localhost:6060/services/planer/building/details/hotel/1").body();
			System.out.println(results);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void getBuildings(HttpClient httpClient) {
		try {
	...
	public static void getAvailableReservations(HttpClient httpClient) {
		try {
	...
	public static void getAllAvailableReservations(HttpClient httpClient) {
		try {
			String results = httpClient.get("http://localhost:6060/services/planer/available/building/hotel").body();
			System.out.println(results);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void addBuilding(HttpClient httpClient) {
		try {
	...
	public static void createReservation(HttpClient httpClient) {
		try {
			String results = httpClient
	...
	public static void createSecondReservation(HttpClient httpClient) {
		try {
			String results = httpClient
